            ...
            modelBuilder.Entity("Eshop.Model.Models.Offer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OfferId = 1,
                            Discount = 0m,
                            EndDate = new DateTime(2024, 3, 20, 3, 40, 29, 328, DateTimeKind.Local).AddTicks(469),
                            IsActive = true,
                            OfferName = "Discount 1",
                            StartDate = new DateTime(2024, 2, 19, 3, 40, 29, 328, DateTimeKind.Local).AddTicks(451),
                            offerType = 0
                        },
                        new
                        {
                            OfferId = 2,
                            Discount = 0m,
                            EndDate = new DateTime(2024, 4, 19, 3, 40, 29, 328, DateTimeKind.Local).AddTicks(480),
                            IsActive = true,
                            OfferName = "Discount 2",
                            StartDate = new DateTime(2024, 2, 19, 3, 40, 29, 328, DateTimeKind.Local).AddTicks(480),
                            offerType = 0
                        },
                        new
                        {
                            OfferId = 3,
                            Discount = 0m,
                            EndDate = new DateTime(2024, 5, 19, 3, 40, 29, 328, DateTimeKind.Local).AddTicks(482),
                            IsActive = true,
                            OfferName = "Discount 3",
                            StartDate = new DateTime(2024, 2, 19, 3, 40, 29, 328, DateTimeKind.Local).AddTicks(482),
                            offerType = 1
                        });
                });
