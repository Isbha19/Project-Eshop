...
namespace Eshop.Data.Migrations
{
    ...
    [Migration("20240218200704_disccountt")]
    partial class disccountt
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Eshop.Model.Models.Offer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OfferId = 1,
                            Discount = 0m,
                            EndDate = new DateTime(2024, 3, 20, 1, 37, 4, 31, DateTimeKind.Local).AddTicks(6608),
                            IsActive = true,
                            OfferName = "Discount 1",
                            StartDate = new DateTime(2024, 2, 19, 1, 37, 4, 31, DateTimeKind.Local).AddTicks(6592),
                            offerType = 0
                        },
                        new
                        {
                            OfferId = 2,
                            Discount = 0m,
                            EndDate = new DateTime(2024, 4, 19, 1, 37, 4, 31, DateTimeKind.Local).AddTicks(6618),
                            IsActive = true,
                            OfferName = "Discount 2",
                            StartDate = new DateTime(2024, 2, 19, 1, 37, 4, 31, DateTimeKind.Local).AddTicks(6617),
                            offerType = 0
                        },
                        new
                        {
                            OfferId = 3,
                            Discount = 0m,
                            EndDate = new DateTime(2024, 5, 19, 1, 37, 4, 31, DateTimeKind.Local).AddTicks(6620),
                            IsActive = true,
                            OfferName = "Discount 3",
                            StartDate = new DateTime(2024, 2, 19, 1, 37, 4, 31, DateTimeKind.Local).AddTicks(6620),
                            offerType = 1
                        });
                });
