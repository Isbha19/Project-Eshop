...
namespace Eshop.Data.Migrations
{
    ...
    [Migration("20240220155052_changedfields")]
            ...
            modelBuilder.Entity("Eshop.Model.Models.Offer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OfferId = 1,
                            Discount = 0.0,
                            EndDate = new DateTime(2024, 3, 21, 21, 20, 50, 974, DateTimeKind.Local).AddTicks(1441),
                            IsActive = true,
                            OfferName = "Discount 1",
                            StartDate = new DateTime(2024, 2, 20, 21, 20, 50, 974, DateTimeKind.Local).AddTicks(1425),
                            offerType = 0
                        },
                        new
                        {
                            OfferId = 2,
                            Discount = 0.0,
                            EndDate = new DateTime(2024, 4, 20, 21, 20, 50, 974, DateTimeKind.Local).AddTicks(1450),
                            IsActive = true,
                            OfferName = "Discount 2",
                            StartDate = new DateTime(2024, 2, 20, 21, 20, 50, 974, DateTimeKind.Local).AddTicks(1449),
                            offerType = 0
                        },
                        new
                        {
                            OfferId = 3,
                            Discount = 0.0,
                            EndDate = new DateTime(2024, 5, 20, 21, 20, 50, 974, DateTimeKind.Local).AddTicks(1452),
                            IsActive = true,
                            OfferName = "Discount 3",
                            StartDate = new DateTime(2024, 2, 20, 21, 20, 50, 974, DateTimeKind.Local).AddTicks(1452),
                            offerType = 1
                        });
                });
