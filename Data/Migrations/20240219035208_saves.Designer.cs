...
namespace Eshop.Data.Migrations
{
    ...
    [Migration("20240219035208_saves")]
    partial class saves
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Eshop.Model.Models.Offer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OfferId = 1,
                            Discount = 0m,
                            EndDate = new DateTime(2024, 3, 20, 9, 22, 7, 981, DateTimeKind.Local).AddTicks(2697),
                            IsActive = true,
                            OfferName = "Discount 1",
                            StartDate = new DateTime(2024, 2, 19, 9, 22, 7, 981, DateTimeKind.Local).AddTicks(2682),
                            offerType = 0
                        },
                        new
                        {
                            OfferId = 2,
                            Discount = 0m,
                            EndDate = new DateTime(2024, 4, 19, 9, 22, 7, 981, DateTimeKind.Local).AddTicks(2706),
                            IsActive = true,
                            OfferName = "Discount 2",
                            StartDate = new DateTime(2024, 2, 19, 9, 22, 7, 981, DateTimeKind.Local).AddTicks(2705),
                            offerType = 0
                        },
                        new
                        {
                            OfferId = 3,
                            Discount = 0m,
                            EndDate = new DateTime(2024, 5, 19, 9, 22, 7, 981, DateTimeKind.Local).AddTicks(2708),
                            IsActive = true,
                            OfferName = "Discount 3",
                            StartDate = new DateTime(2024, 2, 19, 9, 22, 7, 981, DateTimeKind.Local).AddTicks(2707),
                            offerType = 1
                        });
                });
