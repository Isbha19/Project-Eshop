...
namespace Eshop.Data.Migrations
{
    ...
    [Migration("20240220142705_offereddd")]
    partial class offereddd
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Eshop.Model.Models.Offer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OfferId = 1,
                            Discount = 0.0,
                            EndDate = new DateTime(2024, 3, 21, 19, 57, 4, 329, DateTimeKind.Local).AddTicks(310),
                            IsActive = true,
                            OfferName = "Discount 1",
                            StartDate = new DateTime(2024, 2, 20, 19, 57, 4, 329, DateTimeKind.Local).AddTicks(294),
                            offerType = 0
                        },
                        new
                        {
                            OfferId = 2,
                            Discount = 0.0,
                            EndDate = new DateTime(2024, 4, 20, 19, 57, 4, 329, DateTimeKind.Local).AddTicks(320),
                            IsActive = true,
                            OfferName = "Discount 2",
                            StartDate = new DateTime(2024, 2, 20, 19, 57, 4, 329, DateTimeKind.Local).AddTicks(319),
                            offerType = 0
                        },
                        new
                        {
                            OfferId = 3,
                            Discount = 0.0,
                            EndDate = new DateTime(2024, 5, 20, 19, 57, 4, 329, DateTimeKind.Local).AddTicks(322),
                            IsActive = true,
                            OfferName = "Discount 3",
                            StartDate = new DateTime(2024, 2, 20, 19, 57, 4, 329, DateTimeKind.Local).AddTicks(322),
                            offerType = 1
                        });
                });
