...
namespace Eshop.Data.Migrations
{
    ...
    [Migration("20240226103246_originl")]
    partial class originl
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Eshop.Model.Models.Offer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OfferId = 1,
                            Discount = 0.0,
                            EndDate = new DateTime(2024, 3, 27, 16, 2, 45, 129, DateTimeKind.Local).AddTicks(7663),
                            IsActive = true,
                            OfferName = "Discount 1",
                            StartDate = new DateTime(2024, 2, 26, 16, 2, 45, 129, DateTimeKind.Local).AddTicks(7648),
                            offerType = 0
                        },
                        new
                        {
                            OfferId = 2,
                            Discount = 0.0,
                            EndDate = new DateTime(2024, 4, 26, 16, 2, 45, 129, DateTimeKind.Local).AddTicks(7672),
                            IsActive = true,
                            OfferName = "Discount 2",
                            StartDate = new DateTime(2024, 2, 26, 16, 2, 45, 129, DateTimeKind.Local).AddTicks(7671),
                            offerType = 0
                        },
                        new
                        {
                            OfferId = 3,
                            Discount = 0.0,
                            EndDate = new DateTime(2024, 5, 26, 16, 2, 45, 129, DateTimeKind.Local).AddTicks(7674),
                            IsActive = true,
                            OfferName = "Discount 3",
                            StartDate = new DateTime(2024, 2, 26, 16, 2, 45, 129, DateTimeKind.Local).AddTicks(7673),
                            offerType = 1
                        });
                });
