...
namespace Eshop.Data.Migrations
{
    ...
    [Migration("20240220155426_againfieldchanges")]
    partial class againfieldchanges
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Eshop.Model.Models.Offer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OfferId = 1,
                            Discount = 0.0,
                            EndDate = new DateTime(2024, 3, 21, 21, 24, 25, 75, DateTimeKind.Local).AddTicks(2737),
                            IsActive = true,
                            OfferName = "Discount 1",
                            StartDate = new DateTime(2024, 2, 20, 21, 24, 25, 75, DateTimeKind.Local).AddTicks(2721),
                            offerType = 0
                        },
                        new
                        {
                            OfferId = 2,
                            Discount = 0.0,
                            EndDate = new DateTime(2024, 4, 20, 21, 24, 25, 75, DateTimeKind.Local).AddTicks(2746),
                            IsActive = true,
                            OfferName = "Discount 2",
                            StartDate = new DateTime(2024, 2, 20, 21, 24, 25, 75, DateTimeKind.Local).AddTicks(2745),
                            offerType = 0
                        },
                        new
                        {
                            OfferId = 3,
                            Discount = 0.0,
                            EndDate = new DateTime(2024, 5, 20, 21, 24, 25, 75, DateTimeKind.Local).AddTicks(2748),
                            IsActive = true,
                            OfferName = "Discount 3",
                            StartDate = new DateTime(2024, 2, 20, 21, 24, 25, 75, DateTimeKind.Local).AddTicks(2748),
                            offerType = 1
                        });
                });
