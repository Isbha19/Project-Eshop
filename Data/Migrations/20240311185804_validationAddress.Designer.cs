...
namespace Eshop.Data.Migrations
{
    ...
    [Migration("20240311185804_validationAddress")]
    partial class validationAddress
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Eshop.Model.Models.Offer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OfferId = 1,
                            Discount = 0.0,
                            EndDate = new DateTime(2024, 4, 10, 22, 58, 3, 232, DateTimeKind.Local).AddTicks(5341),
                            IsActive = true,
                            OfferName = "Discount 1",
                            StartDate = new DateTime(2024, 3, 11, 22, 58, 3, 232, DateTimeKind.Local).AddTicks(5320),
                            offerType = 0
                        },
                        new
                        {
                            OfferId = 2,
                            Discount = 0.0,
                            EndDate = new DateTime(2024, 5, 10, 22, 58, 3, 232, DateTimeKind.Local).AddTicks(5354),
                            IsActive = true,
                            OfferName = "Discount 2",
                            StartDate = new DateTime(2024, 3, 11, 22, 58, 3, 232, DateTimeKind.Local).AddTicks(5353),
                            offerType = 0
                        },
                        new
                        {
                            OfferId = 3,
                            Discount = 0.0,
                            EndDate = new DateTime(2024, 6, 9, 22, 58, 3, 232, DateTimeKind.Local).AddTicks(5390),
                            IsActive = true,
                            OfferName = "Discount 3",
                            StartDate = new DateTime(2024, 3, 11, 22, 58, 3, 232, DateTimeKind.Local).AddTicks(5389),
                            offerType = 1
                        });
                });
