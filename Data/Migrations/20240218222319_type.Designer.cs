            ...
            modelBuilder.Entity("Eshop.Model.Models.Offer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OfferId = 1,
                            Discount = 0m,
                            EndDate = new DateTime(2024, 3, 20, 3, 53, 18, 121, DateTimeKind.Local).AddTicks(3039),
                            IsActive = true,
                            OfferName = "Discount 1",
                            StartDate = new DateTime(2024, 2, 19, 3, 53, 18, 121, DateTimeKind.Local).AddTicks(3022),
                            offerType = 0
                        },
                        new
                        {
                            OfferId = 2,
                            Discount = 0m,
                            EndDate = new DateTime(2024, 4, 19, 3, 53, 18, 121, DateTimeKind.Local).AddTicks(3049),
                            IsActive = true,
                            OfferName = "Discount 2",
                            StartDate = new DateTime(2024, 2, 19, 3, 53, 18, 121, DateTimeKind.Local).AddTicks(3048),
                            offerType = 0
                        },
                        new
                        {
                            OfferId = 3,
                            Discount = 0m,
                            EndDate = new DateTime(2024, 5, 19, 3, 53, 18, 121, DateTimeKind.Local).AddTicks(3051),
                            IsActive = true,
                            OfferName = "Discount 3",
                            StartDate = new DateTime(2024, 2, 19, 3, 53, 18, 121, DateTimeKind.Local).AddTicks(3050),
                            offerType = 1
                        });
                });
