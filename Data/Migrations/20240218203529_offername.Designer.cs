...
namespace Eshop.Data.Migrations
{
    ...
    [Migration("20240218203529_offername")]
    partial class offername
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Eshop.Model.Models.Offer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OfferId = 1,
                            Discount = 0m,
                            EndDate = new DateTime(2024, 3, 20, 2, 5, 28, 258, DateTimeKind.Local).AddTicks(803),
                            IsActive = true,
                            OfferName = "Discount 1",
                            StartDate = new DateTime(2024, 2, 19, 2, 5, 28, 258, DateTimeKind.Local).AddTicks(785),
                            offerType = 0
                        },
                        new
                        {
                            OfferId = 2,
                            Discount = 0m,
                            EndDate = new DateTime(2024, 4, 19, 2, 5, 28, 258, DateTimeKind.Local).AddTicks(815),
                            IsActive = true,
                            OfferName = "Discount 2",
                            StartDate = new DateTime(2024, 2, 19, 2, 5, 28, 258, DateTimeKind.Local).AddTicks(814),
                            offerType = 0
                        },
                        new
                        {
                            OfferId = 3,
                            Discount = 0m,
                            EndDate = new DateTime(2024, 5, 19, 2, 5, 28, 258, DateTimeKind.Local).AddTicks(818),
                            IsActive = true,
                            OfferName = "Discount 3",
                            StartDate = new DateTime(2024, 2, 19, 2, 5, 28, 258, DateTimeKind.Local).AddTicks(817),
                            offerType = 1
                        });
                });
