...
namespace Eshop.Data.Migrations
{
    ...
    [Migration("20240219021643_offerprice")]
            ...
            modelBuilder.Entity("Eshop.Model.Models.Offer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OfferId = 1,
                            Discount = 0m,
                            EndDate = new DateTime(2024, 3, 20, 7, 46, 43, 19, DateTimeKind.Local).AddTicks(3917),
                            IsActive = true,
                            OfferName = "Discount 1",
                            StartDate = new DateTime(2024, 2, 19, 7, 46, 43, 19, DateTimeKind.Local).AddTicks(3903),
                            offerType = 0
                        },
                        new
                        {
                            OfferId = 2,
                            Discount = 0m,
                            EndDate = new DateTime(2024, 4, 19, 7, 46, 43, 19, DateTimeKind.Local).AddTicks(3926),
                            IsActive = true,
                            OfferName = "Discount 2",
                            StartDate = new DateTime(2024, 2, 19, 7, 46, 43, 19, DateTimeKind.Local).AddTicks(3926),
                            offerType = 0
                        },
                        new
                        {
                            OfferId = 3,
                            Discount = 0m,
                            EndDate = new DateTime(2024, 5, 19, 7, 46, 43, 19, DateTimeKind.Local).AddTicks(3928),
                            IsActive = true,
                            OfferName = "Discount 3",
                            StartDate = new DateTime(2024, 2, 19, 7, 46, 43, 19, DateTimeKind.Local).AddTicks(3928),
                            offerType = 1
                        });
                });
